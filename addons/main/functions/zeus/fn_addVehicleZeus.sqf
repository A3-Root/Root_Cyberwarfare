...
if (_useRadiusMode) then {
    ...
    if (_isDrone) then {
        ...
        _dialogControls = [
            ...
            ["SLIDER", ["Min Speed Boost (km/h)", "Minimum speed boost (negative = slowdown). Range -2000 to 2000."], [-2000, 2000, -50, 0]],
            ["SLIDER", ["Max Speed Boost (km/h)", "Maximum speed boost. Range -2000 to 2000."], [-2000, 2000, 50, 0]],
