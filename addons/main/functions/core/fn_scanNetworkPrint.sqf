...
[_computer, [[["IP Address        Type     SSH   Interface", "#FFD966"]]]] call AE3_armaos_fnc_shell_stdout;
...

{
    ...
    [_computer, [[[_ip, "#008DF8"], [format ["   %1   SSH:%2   %3", _type, _ssh, _iface], ""]]]] call AE3_armaos_fnc_shell_stdout;
} forEach _rows;
