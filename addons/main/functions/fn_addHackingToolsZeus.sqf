...
private _index = missionNamespace getVariable ["ROOT_customLaptopNameIndex", 1];
ROOT_customLaptopName = format ["HackingPlatform_%1", _index];
...
[
	...
	["EDIT", ["Laptop Name", "Custom Name to be given to the laptop for easier management of devices. Only visible to curators when linking devices to specific laptops."], [ROOT_customLaptopName]]
		...
		_index = _index + 1;
		missionNamespace setVariable ["ROOT_customLaptopNameIndex", _index, true];
