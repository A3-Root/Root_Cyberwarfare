...
private _targetObject = vehicle _player;
...
[_targetObject, clientOwner, _allComputers, _trackerName, _trackingTime, _updateFrequency, _customMarker, _availableToFutureLaptops, _allowRetracking, _lastPingTimer, _powerCost] remoteExec ["Root_fnc_addGPSTrackerZeusMain", 2];

// Update index
missionNamespace setVariable ["ROOT_gpsTrackerIndex", _index + 1, true];

["GPS Tracker attached successfully!", 2] call ACE_common_fnc_displayTextStructured;
