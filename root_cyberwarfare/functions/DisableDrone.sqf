...
if((_droneIdNum != 0 || _droneId isEqualTo "a")) then {
    ...
    if(_droneId isEqualTo "a") then {
        ...
        if (count _affectedDrones == 0) then {
        ...
        [_computer, _battery, (_powerCostPerDrone * _countOfChangingDrones)] call compile preprocessFileLineNumbers "root_cyberwarfare\functions\RemovePower.sqf";
        ...
        
        {
            ...
            if(_idOfDrone == _droneIdNum) then {
                ...
                if (alive _drone && damage _drone < 1) then {
                    ...
                    [_computer, _string] call AE3_armaos_fnc_shell_stdout;
                    [_computer, _battery, _powerCostPerDrone] call compile preprocessFileLineNumbers "root_cyberwarfare\functions\RemovePower.sqf";
                } else {
